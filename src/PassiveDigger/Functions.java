...
import static PassiveDigger.PassiveAnalyzer.AnalyzerTable;
...
public class Functions {
    ...
    public static void updateRowNumbers(JTable table_name){
        DefaultTableModel tableModel=(DefaultTableModel)table_name.getModel();
        for (int i = 0; i < table_name.getRowCount(); i++) {
